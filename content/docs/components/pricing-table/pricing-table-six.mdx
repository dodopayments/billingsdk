...
description: A comprehensive pricing table component with slider (rendered disabled/non-interactive), pricing plans, and detailed comparison table. Perfect for showcasing complex pricing structures with feature comparisons.
---
...
- **Header**: Engaging title and description with user count display
- **Dynamic Pricing Cards**: Three-tier pricing structure with popular plan highlighting
- **Slider**: Visual representation of user count (rendered disabled/non-interactive) - shows 5 users for Basic, 15 users for Business, and 25+ users for Enterprise
