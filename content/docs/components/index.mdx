...
| **[Pricing Table Six](/docs/components/pricing-table/pricing-table-six)** | Comprehensive pricing table with slider (rendered disabled/non-interactive), plans, and detailed comparison table |
