...
Smart proration and cost calculation components for subscription plan modifications.

| Component | Description |
|-----------|-------------|
| **[Proration Preview](/docs/components/proration-preview)** | Shows detailed cost breakdown when changing subscription plans with credits and charges |
