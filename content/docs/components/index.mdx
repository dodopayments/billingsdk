...
| **[Pricing Table Six](/docs/components/pricing-table/pricing-table-six)** | Comprehensive pricing table with interactive slider, plans, and detailed comparison table |
