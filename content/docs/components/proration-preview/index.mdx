...
<Tabs items={['Preview', 'Code']} className="bg-transparent border-none">
  <Tab value="Preview" className="border-none bg-transparent p-0 mt-3">
    <PreviewComponents registryName="plan-change-calculator">
      <PlanChangeCalculatorDemo />
    </PreviewComponents>
  </Tab>

<Tab value="Code" className="mt-3">
  <include cwd lang="tsx" meta='title="src/components/plan-change-calculator-demo.tsx"'>src/components/plan-change-calculator-demo.tsx</include>
  </Tab>
...
<Tabs items={['shadcn', 'billingSDK']} defaultValue="shadcn" className="bg-transparent border-none">
  <Tab value="shadcn" className="border-none bg-transparent p-0 mt-3">
    <Tabs items={['npx', 'pnpm', 'yarn', 'bun']} defaultValue="npx" groupId="installation-tabs">
      <Tab value="npx">
        ```bash
        npx shadcn@latest add @billingsdk/plan-change-calculator
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash
        pnpm dlx shadcn@latest add @billingsdk/plan-change-calculator
        ```
      </Tab>
      <Tab value="yarn">
        ```bash
        yarn dlx shadcn@latest add @billingsdk/plan-change-calculator
        ```
      </Tab>
      <Tab value="bun">
        ```bash
        bunx shadcn@latest add @billingsdk/plan-change-calculator
        ```
      </Tab>
    </Tabs>
  </Tab>
  <Tab value="billingSDK" className="border-none bg-transparent p-0 mt-3">
    <Tabs items={['npx', 'pnpm', 'yarn', 'bun']} defaultValue="npx" groupId="billingsdk-cli-tabs">
      <Tab value="npx">
        ```bash
        npx @billingsdk/cli add plan-change-calculator
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash
        pnpm dlx @billingsdk/cli add plan-change-calculator
        ```
      </Tab>
      <Tab value="yarn">
        ```bash
        yarn dlx @billingsdk/cli add plan-change-calculator
        ```
      </Tab>
      <Tab value="bun">
        ```bash
        bunx @billingsdk/cli add plan-change-calculator
        ```
      </Tab>
    </Tabs>
  </Tab>
...
<include cwd lang="tsx" meta='title="src/registry/billingsdk/plan-change-calculator.tsx"'>src/registry/billingsdk/plan-change-calculator.tsx</include>

**Step 3**: The component is self-contained and includes all necessary types and logic.
