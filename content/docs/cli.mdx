...
| Framework  | Dodo Payments | Stripe        | PayPal       |
|------------|---------------|---------------|--------------|
| Next.js    | Yes           | Coming soon   | Yes          |
| Express.js | Yes           | Yes           | Coming soon  |
| Hono       | Yes           | Yes           | Coming soon  |
| React      | Yes           | Coming soon   | Coming soon  |
| Fastify    | Yes           | Coming soon   | Coming soon  |
...
### Stripe
- ✅ **Status**: Supported for Express.js and Hono
- 📚 **Integration**: Express.js, Hono
- 🚧 **Adding Soon**: Next.js, React.js, Fastify

### PayPal
- ✅ **Status**: Supported for Next.js
- 📚 **Integration**: Next.js
- 🚧 **Adding Soon**: Express.js, Hono, React.js, Fastify
...
- **Payment Provider**: Dodo Payments, Stripe, or PayPal (PayPal currently supported for Next.js; Stripe supported for Express.js and Hono)

### Generated Files (Dodo Payments)

After running `init` with Dodo Payments, you'll get:

<Tabs items={['Next.js + Dodo Payments', 'Express.js + Dodo Payments', 'React.js + Dodo Payments', 'Hono + Dodo Payments', 'Fastify + Dodo Payments', "Nextjs+ Stripe", "Express + Stripe"]}>
...
<Tabs items={['Express.js + Stripe', 'Hono + Stripe']}>
...
### Generated Files (PayPal)

After running `init` with PayPal, you'll get:

<Tabs items={['Next.js + PayPal']}>
  <Tab value="Next.js + PayPal">
    ```
    your-project/
    ├── app/api/
    │   ├── (paypal)/
