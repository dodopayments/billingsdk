...
1. **Framework Selection**: Choose your preferred framework (Next.js or Express.js or Hono)
...
- **Framework**: Next.js (with App Router) or Express.js (Node.js web framework) or Hono (lightweight web framework)
...
<Tabs items={['Next.js + Dodo Payments', 'Express.js + Dodo Payments','Hono + Dodo Payments' 'React.js + Dodo Payments']}>
...
<Tabs items={['Next.js', 'Express.js','Hono', "React.js"]}>
  <Tab value="Next.js">
    ```json
    {
      "dependencies": {
...
import { dodopaymentsRouter } from './routes/dodopayments/route'
