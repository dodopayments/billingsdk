...
2. **Provider Selection**: Select your payment provider (currently Dodo Payments and stripe)
...
- **Payment Providers**: Dodo Payments or Stripe
...
<Tabs items={['Next.js', 'Express.js', "React.js"]}>
  <Tab value="Next.js">
    ```json
    {
      "dependencies": {
