...
export function ViewOptions({
  ...
  const items = useMemo(() => {
    const fullMarkdownUrl =
      isHydrated && typeof window !== "undefined"
        ...
        : markdownUrl; // Use relative URL during SSR
  ...
  }, [githubUrl, markdownUrl, isHydrated]);
    ...
    <a
      ...
      className={cn(
        buttonVariants({
          variant: "secondary",
          className:
            "gap-2 [&_svg]:size-3.5 [&_svg]:text-fd-muted-foreground rounded-md",
        })
      )}
      onClick={(e) => {
        ...
        <button
          ...
          className={cn(
            buttonVariants({
              variant: "secondary",
              className:
                "gap-2 [&_svg]:size-3.5 [&_svg]:text-fd-muted-foreground rounded-none rounded-l-md",
            })
          )}
          onClick={onClick}
        >
