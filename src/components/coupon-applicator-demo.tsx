...
/**
 * Renders a secure checkout demo with an order summary and an integrated CouponApplicator.
 *
 * Displays subtotal, tax, shipping, and total, and provides a coupon flow that:
 * - Validates coupon codes asynchronously (simulates an ~800ms API delay).
 * - Accepts the static codes SAVE10, SAVE20, and FLAT50 (returning their respective ValidationResult).
 * - Enables the "Proceed to Payment" button when a coupon is successfully applied and disables it when removed.
 *
 * This component is intended as a self-contained UI demo and does not perform real network requests.
 */
