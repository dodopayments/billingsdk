...
const getDialogContainerClass = (leftPanelImageUrl?: string, className?: string) => {
...
const formatDialogPlanPrice = (price?: string, currency?: string) => {
