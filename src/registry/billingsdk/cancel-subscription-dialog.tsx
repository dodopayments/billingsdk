  ...
  return (
    ...
    >
      ...
      >
        ...
        <DialogClose
          className="absolute top-4 right-4 z-10 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:ring-2 focus:ring-ring focus:ring-offset-2 focus:outline-none disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground"
        ...
        {leftPanelImageUrl && (
          <div className="relative hidden min-h-[500px] w-full overflow-hidden md:block md:w-1/2">
            ...
            />
            <div className="absolute inset-0 hidden bg-gradient-to-r from-transparent via-background/30 to-background/90 dark:block"></div>
            <div className="absolute inset-0 hidden bg-gradient-to-t from-background/80 via-transparent to-background/20 dark:block"></div>
          </div>
        )}
        <div
          className={cn(
