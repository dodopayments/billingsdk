...
const getBannerVariantStyles = (variant: BannerProps["variant"], gradientColors?: string[]) => {
...
const getBannerGradientBackground = (gradientColors?: string[]) => {
...
const getBannerAnimationProps = (variant: BannerProps["variant"]) => {
  switch (variant) {
    case "popup":
      return {
