...
function DemoContent() {
  ...
  return (
    <div className="container mx-auto space-y-24 py-12">
      {/* i18n Controls */}
      <section className="bg-muted flex flex-col items-center gap-6 rounded-2xl border p-8">
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Comprehensive insights into your business growth.
          </p>
        </div>
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            A unified interface for your customers to manage their billing,
      ...
      <section className="space-y-8">
        <div className="space-y-2">
          <h3 className="text-center text-3xl font-bold">Localized Pricing</h3>
          <p className="text-muted-foreground text-center">
            Existing components now support localized currencies through the
            BillingProvider.
          </p>
        </div>
        <PricingTableOne
      ...
      <footer className="text-muted-foreground pt-12 text-center">
